define("mvc/ui/ui-options", ["exports", "backbone", "underscore", "utils/utils", "mvc/ui/ui-buttons"], function(exports, _backbone, _underscore, _utils, _uiButtons) {
    "use strict";
    ...
    RadioButton.View = Base.extend({
        ...
        _templateOption: function _templateOption(pair) {
            ...
            if (pair.icon) {
                $el.append($("<i/>").addClass("fa").addClass(pair.icon).addClass(!pair.label && "no-padding"));
            }
