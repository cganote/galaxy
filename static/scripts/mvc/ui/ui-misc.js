define("mvc/ui/ui-misc", ["exports", "mvc/ui/ui-select-default", "mvc/ui/ui-slider", "mvc/ui/ui-options", "mvc/ui/ui-drilldown", "mvc/ui/ui-buttons", "mvc/ui/ui-modal"], function(exports, _uiSelectDefault, _uiSlider, _uiOptions, _uiDrilldown, _uiButtons, _uiModal) {
    ...
    exports.Drilldown = exports.Slider = exports.Select = exports.Radio = exports.RadioButton = exports.Checkbox = exports.ButtonLink = exports.ButtonMenu = exports.ButtonCheck = exports.ButtonIcon = exports.Button = exports.Upload = exports.TextSelect = exports.Hidden = exports.Input = exports.UnescapedMessage = exports.Message = exports.Label = undefined;
    ...
    var TextSelect = exports.TextSelect = Backbone.View.extend({
        initialize: function initialize(options) {
            var _this = this;
