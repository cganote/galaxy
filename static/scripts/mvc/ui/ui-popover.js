define("mvc/ui/ui-popover", ["exports", "backbone", "underscore", "utils/utils"], function(exports, _backbone, _underscore, _utils) {
    "use strict";
    ...
    var View = Backbone.View.extend({
        ...
        initialize: function initialize(options) {
            ...
            $("body").on("mousedown." + this.uid, function(e) {
                ...
                if (self.visible && !$(self.options.container).is(e.target) && !$(self.el).is(e.target) && $(self.el).has(e.target).length === 0) {
                    self.hide();
                }
            });
        },
        ...
        render: function render() {
            ...
            this.$el.removeClass().addClass("ui-popover popover in").addClass(this.options.placement);
