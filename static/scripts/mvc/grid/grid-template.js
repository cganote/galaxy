define("mvc/grid/grid-template", ["exports", "utils/utils", "underscore"], function(exports, _utils, _underscore) {
    "use strict";
    ...
    exports.default = {
        ...
        footer: function footer(options) {
            ...
            if (options.use_paging && options.num_pages > 1) {
                ...
                if (min_page > 1) {
                    tmpl += '<span class="page-link-grid" id="page-link-1"><a href="javascript:void(0);" page_num="1" onclick="return false;">1</a></span> ...';
                }
