define("mvc/collection/collection-model", ["exports", "mvc/dataset/dataset-model", "mvc/base-mvc", "utils/utils", "utils/localization"], function(exports, _datasetModel, _baseMvc, _utils, _localization) {
    "use strict";
    ...
    var DatasetDCE = _datasetModel2.default.DatasetAssociation.extend(_baseMvc2.default.mixin(DatasetCollectionElementMixin,
        /** @lends DatasetDCE.prototype */
        {
            ...
            url: function url() {
                ...
                var url = Galaxy.root + "api/histories/" + this.get("history_id") + "/contents/" + datasetId;
                return url;
            },

            _getDatasetId: function _getDatasetId() {
    ...
    var DatasetCollection = Backbone.Model.extend(_baseMvc2.default.LoggableMixin).extend(_baseMvc2.default.SearchableModelMixin).extend(
        /** @lends DatasetCollection.prototype */
        {
            ...
            delete: function _delete(recursive, purge, options) {
                ...
                options = _utils2.default.merge(options, {
                    method: "delete"
                });
                return this.save({
                    deleted: true,
