define("mvc/collection/list-of-pairs-collection-creator", ["exports", "utils/levenshtein", "utils/natural-sort", "mvc/collection/base-creator", "mvc/base-mvc", "utils/localization", "ui/hoverhighlight"], function(exports, _levenshtein, _naturalSort, _baseCreator, _baseMvc, _localization) {
    "use strict";
    ...
    var PairView = Backbone.View.extend(_baseMvc2.default.LoggableMixin).extend({
        ...
        render: function render() {
            ...
            var handle = this.$el.attr("draggable", true).data("pair", this.pair).html(this.template({
                pair: this.pair
            })).addClass("flex-column-container").get(0);
    ...
    var PairedCollectionCreator = Backbone.View.extend(_baseMvc2.default.LoggableMixin).extend(_baseCreator2.default.CollectionCreatorMixin).extend({
        ...
        unpairAll: function unpairAll() {
            ...
            while (this.paired.length) {
                pairs.push(this._unpair(this.paired[0], {
                    silent: true
                }));
            }
        ...
        _pairToJSON: function _pairToJSON(pair) {
        ...
        pairAllSelected: function pairAllSelected(options) {
            ...
            fwds.forEach(function(fwd, i) {
                try {
                    pairs.push(self._pair(fwd, revs[i], {
                        silent: true
                    }));
                } catch (err) {
