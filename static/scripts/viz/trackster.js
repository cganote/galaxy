        ...
        _createClass(TracksterUI, [{
            ...
            value: function createButtonMenu() {
                ...
                var menu = _iconButton2.default.create_icon_buttons_menu([{
                    ...
                    on_click: function on_click() {
                        window.top.location = _this3.baseURL + "visualization/circster?id=" + _this3.view.vis_id;
                    }
                }, {
    ...
    var TracksterUIView = function(_Backbone$View) {
        ...
        _createClass(TracksterUIView, [{
            ...
            value: function template_view_new(response) {
                ...
                html += "</select></div><div style=\"clear: both;\"></div></div><div class=\"form-row\">Is the build not listed here? <a href=\"" + Galaxy.root + "custom_builds\" target=\"_top\">Add a Custom Build</a></div></form>";
