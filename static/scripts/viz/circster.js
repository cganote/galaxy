define("viz/circster", ["exports", "utils/localization", "libs/underscore", "d3", "viz/visualization", "utils/utils", "utils/config", "mvc/ui/icon-button", "libs/farbtastic"], function(exports, _localization, _underscore, _d, _visualization, _utils, _config, _iconButton) {
    "use strict";
        ...
        render: function render() {
            ...
            var // Set up SVG element.
                ...
                .append("svg:g").call(d3.behavior.zoom().on("zoom", function() {
                    // Do zoom, drag.
                    var scale = _d.event.scale;
                    svg.attr("transform", "translate(" + _d.event.translate + ") scale(" + scale + ")");
    ...
    var Circster = Backbone.View.extend({
        initialize: function initialize() {
            ...
            var genome = new _visualization2.default.Genome(window.galaxy_config.app.genome);

            var vis = new _visualization2.default.GenomeVisualization(window.galaxy_config.app.viz_config);
            ...
            // setup title
            $("#center .unified-panel-header-inner").append(window.galaxy_config.app.viz_config.title + " " + window.galaxy_config.app.viz_config.dbkey);
