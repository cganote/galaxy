...
describe('Markdown', function () {
	var expectSnapshotToMatch = function expectSnapshotToMatch(markdown) {
		var actual = render(_react2.default.createElement(_Markdown2.default, { text: markdown }));
	...
	it('should forward DOM attributes onto resulting HTML', function () {
		...
		var actual = mount(_react2.default.createElement(_Markdown2.default, { text: markdown }));
...
describe('Markdown inline', function () {
	var expectSnapshotToMatch = function expectSnapshotToMatch(markdown) {
		var actual = render(_react2.default.createElement(_Markdown2.default, { text: markdown, inline: true }));
