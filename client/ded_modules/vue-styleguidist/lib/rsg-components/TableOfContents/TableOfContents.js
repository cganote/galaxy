...
var _filterSectionsByName = require('../../utils/filterSectionsByName');
...
var TableOfContents = function (_Component) {
	...
	_createClass(TableOfContents, [{
		...
		value: function renderLevel(sections) {
			...
			var useIsolatedLinks = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
			...
			var items = sections.map(function (section) {
				...
				return Object.assign({}, section, {
					...
					content: children.length > 0 && _this2.renderLevel(children, useIsolatedLinks)
				});
			});
			return _react2.default.createElement(_ComponentsList2.default, { items: items, useIsolatedLinks: useIsolatedLinks });
		}
	}, {
		key: 'renderSections',
		value: function renderSections() {
			...
			var _props = this.props,
			    ...
			    useIsolatedLinks = _props.useIsolatedLinks;
