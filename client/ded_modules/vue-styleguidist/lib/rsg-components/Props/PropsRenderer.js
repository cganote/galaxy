			...
			if (defaultValueBlacklist.indexOf(prop.defaultValue.value) > -1) {
				...
				return _react2.default.createElement(
					_Text2.default,
					{
						...
						color: 'light',
						underlined: true,
						title: (0, _util.showSpaces)((0, _util.unquote)(prop.defaultValue.value))
					},
					'Function'
				);
				...
				try {
					...
					return _react2.default.createElement(
						_Text2.default,
						{ size: 'small', color: 'light', underlined: true, title: (0, _javascriptStringify2.default)(object, null, 2) },
						'Shape'
					);
				} catch (e) {
...
function renderDescription(prop) {
	...
	return _react2.default.createElement(
		...
		returnDocumentation && _react2.default.createElement(_Argument2.default, _extends({}, returnDocumentation, { returns: true }))
	);
}
...
function renderTypeColumn(prop) {
	if (prop.flowType) {
		return _react2.default.createElement(
			_Type2.default,
			null,
			renderFlowType((0, _util.getType)(prop))
		);
	}
	return _react2.default.createElement(
		_Type2.default,
...
function PropsRenderer(_ref2) {
	...
	return _react2.default.createElement(_Table2.default, { columns: columns, rows: props, getRowKey: getRowKey });
}

PropsRenderer.propTypes = {
	props: _propTypes2.default.array.isRequired
};